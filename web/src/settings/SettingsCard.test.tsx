...
describe('SettingsCard', () => {
  it('渲染标题与描述', () => {
    render(<I18nProvider initialLang="en"><SettingsCard title="Engine" description="Master switch">body</SettingsCard></I18nProvider>)
  ...
  it('configured 状态显示绿色已配置 badge', () => {
    render(<I18nProvider initialLang="en"><SettingsCard title="X" status="configured">b</SettingsCard></I18nProvider>)
    expect(screen.getByText('✓ Configured')).toBeInTheDocument()
  })

  it('unconfigured 状态显示黄色未配置 badge', () => {
    render(<I18nProvider initialLang="en"><SettingsCard title="X" status="unconfigured">b</SettingsCard></I18nProvider>)
